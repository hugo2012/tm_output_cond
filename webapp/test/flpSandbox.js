		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TM: output condition table maintenance",
									"targetURL": "#comboschrb1mtmtmoutputcond-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comboschrb1mtmtmoutputcond-display": {
								"semanticObject": "comboschrb1mtmtmoutputcond",
								"action": "display",
								"description": "TM: output condition table maintenance",
								"title": "TM: output condition table maintenance",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bosch.rb1m.tm.tmoutputcond",
									"url": sap.ui.require.toUrl("com/bosch/rb1m/tm/tmoutputcond")
								}
							}
						}
					}
