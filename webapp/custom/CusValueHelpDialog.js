            ...
            let dialog = await new ValueHelpDialog({
                             ...
                             if(dialogMetadata.modeQuery == 2)
                            {
                                 switch(dialogMetadata.entityName)
                                 {
                                    case "SHIPPING_POINT":
                                        ...
                                        break;
                                    case "SHIP_TO_PARTY":    
                                    dialogMetadata.oService.getShipToPartySet(filter).then(
                                        function (oData) {   
                                           // debugger;
                                            dialogMetadata.oModel.setProperty("/ShipToPartySet", []);
                                            dialogMetadata.oModel.setProperty("/ShipToPartySet", oData.results);
                                        ...
                                        break;
                                    case "CSP":    
                                    dialogMetadata.oService.getCSPSet(filter).then(
                                        function (oData) {   
                                           // debugger;
                                            dialogMetadata.oModel.setProperty("/ShipToPartySet", []);
                                            dialogMetadata.oModel.setProperty("/ShipToPartySet", oData.results);
                                        ...
                                        break;    
                                    case "DEST_COUNTRY":    
                                    dialogMetadata.oService.getCountrySet(filter).then(
                                        function (oData) {   
                                           // debugger;
                                            dialogMetadata.oModel.setProperty("/ShipToPartySet", []);
                                            dialogMetadata.oModel.setProperty("/ShipToPartySet", oData.results);
                                        ...
                                        dialogMetadata.oService.getOutputDeviceSet(filter).then(
                                            ...
                                            break;      
                                            case "ASNPartner":    
                                            dialogMetadata.oService.getASNPartnerSet(filter).then(
                                                function (oData) {   
                                                   // debugger;
                                                    dialogMetadata.oModel.setProperty("/ShipToPartySet", []);
                                                    dialogMetadata.oModel.setProperty("/ShipToPartySet", oData.results);
                                                ...
                                                break;   
                                            case "Print_Language":    
                                            dialogMetadata.oService.getLanguage(filter).then(
                                                function (oData) {   
                                                   // debugger;
                                                    dialogMetadata.oModel.setProperty("/ShipToPartySet", []);
                                                    dialogMetadata.oModel.setProperty("/ShipToPartySet", oData);
                                                    dialogMetadata.oModel.setProperty("/FieldsSetInlineCount",  0);     
                                                    var p = oData.__count - 2;
                                                    dialogMetadata.oModel.setProperty("/FieldsSetInlineCount",  p);  
                                                    dialog.update();
                ...
                o_FilterBar.addEventDelegate({
                    onAfterRendering:   function() {
                     ...
                     //var oInfoBar = oTable.getInfoToolbar();
